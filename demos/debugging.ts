...
someVec2.cells.forEach((cell) => console.log(cell))
...
xed1.cells.forEach((cell) => console.log(cell))

console.log("X on 2")
const xed2 = opX.mulVecPartial([1], someVec2)
console.log(xed2.toString())
xed2.cells.forEach((cell) => console.log(cell))

console.log("Now adding one more dim.")

const someVec3 = someVec2.outer(Vector.fromSparseCoordNames([["u", Cx(1)], ["d", Cx(10)]], [dimSpin]))
console.log(someVec3.toString())
someVec3.cells.forEach((cell) => console.log(cell))

const someVec3bis = Vector.fromSparseCoordNames([["u", Cx(1)], ["d", Cx(10)]], [dimSpin]).outer(someVec2)
console.log(someVec3bis.toString())
someVec3bis.cells.forEach((cell) => console.log(cell))
